---
title: "Apache Kafka: Part 4 - Development Tools and APIs"
...
<Alert type="info">
**Full disclosure:** This content comes from the **Confluent Apache Kafka Fundamentals Course** at [training.confluent.io](https://training.confluent.io). Make sure you've read [Part 1](/blog/kafka/kafka-part-1-introduction), [Part 2](/blog/kafka/kafka-part-2-building-blocks), and [Part 3](/blog/kafka/kafka-part-3-cluster-architecture) for the full context!
</Alert>
