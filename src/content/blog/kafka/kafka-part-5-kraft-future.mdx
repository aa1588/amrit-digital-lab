...
pubDate: "2024-12-16"
heroImage: "/blog-images/kafka-kraft.svg"
tags: ["kafka"]
series: "Apache Kafka"
seriesOrder: 5
---
...
<Alert type="info">
This is Part 5 of our comprehensive Kafka series. Make sure you've read the previous parts: [Part 1 (Introduction)](/blog/kafka/kafka-part-1-introduction), [Part 2 (Building Blocks)](/blog/kafka/kafka-part-2-building-blocks), [Part 3 (Development Tools)](/blog/kafka/kafka-part-3-development-tools), and [Part 4 (Administration)](/blog/kafka/kafka-part-4-administration-monitoring).
</Alert>
...
graph TB
    ...
    subgraph "Modern Kafka with KRaft"
        C1[Controller 1]
        C2[Controller 2]
        C3[Controller 3]
        KB1[Broker 1]
...
sequenceDiagram
    ...
    participant FC as Follower Controller
    participant B as Broker
    
    AC->>AC: Write metadata change
    FC->>AC: Fetch latest metadata
    B->>AC: Fetch latest metadata
    AC-->>FC: Metadata updates
    AC-->>B: Metadata updates
```
...
Thank you for joining us on this comprehensive journey through Apache Kafka! The event streaming revolution continues, and now you're equipped with the knowledge to be part of it.