---
title: 'Apache Kafka: Part 1 - Why Event Streaming Matters'
description: 'Learn why Apache Kafka has become the standard for real time event streaming. Understand the shift from batch processing to event driven architectures.'
pubDate: 2024-12-16
...
<Alert type="info">
**Full disclosure:** Most of what I'm sharing here comes from the **Confluent Apache Kafka Fundamentals Course** at [training.confluent.io](https://training.confluent.io). I'm just trying to make it more digestible and document my learning journey!
</Alert>
